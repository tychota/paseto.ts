...
xdescribe('Protocol V2 Test Vectors', () => {
  it('true', () => {
  ...
  //             return done(err);
  //           }
  //           expect(token).toBe('v2.local.driRNhM20GQPvlWfJCepzh6HdijAq-yNUtKpdy5KXjKfpSKrOlqQvQ');
  //           done();
  //         });
  //       });
  ...
  //             return done(err);
  //           }
  //           expect(token).toBe('v2.local.driRNhM20GQPvlWfJCepzh6HdijAq-yNSOvpveyCsjPYfe9mtiJDVg');
  //           done();
  //         });
  //       });
  ...
  //             return done(err);
  //           }
  //           expect(token).toBe('v2.local.driRNhM20GQPvlWfJCepzh6HdijAq-yNkIWACdHuLiJiW16f2GuGYA');
  //           done();
  //         });
  //       });
